...
public protocol RationalConvertible {
	
	var rationalValue:Rational{ get set }
	
}

extension Rational:RationalConvertible{
...
extension Double:RationalConvertible{
	
	public var  rationalValue:Rational {
		get {
			return Rational( floatLiteral:self )
		}
		set( newValue ){
...
extension Int:RationalConvertible{
	
	public var rationalValue:Rational {
		get {
			return Rational( integerLiteral:self )
		}
		set( newValue ){
			self = Int( newValue.doubleValue )
		}
	}
	
}

// MARK: RationalConvertible math

public func == (lhs: RationalConvertible, rhs: RationalConvertible) -> Bool {
	return lhs.rationalValue == rhs.rationalValue
}
...
public prefix func - ( arg: RationalConvertible) -> RationalConvertible {
	return -arg.rationalValue
}

public func + (lhs: RationalConvertible, rhs: RationalConvertible) -> Rational {
	return lhs.rationalValue + rhs.rationalValue
}
...
public func += ( inout lhs:Rational, rhs:RationalConvertible ) {
	let r = rhs.rationalValue
	lhs = lhs + r
}
